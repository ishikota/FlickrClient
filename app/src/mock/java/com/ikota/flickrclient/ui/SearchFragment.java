...
public class SearchFragment extends Fragment{
    ...
    private SearchAdapter.OnClickCallback mItemClickListener = new SearchAdapter.OnClickCallback() {
        @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(mAppContext, 3);
